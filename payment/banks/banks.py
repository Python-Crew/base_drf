...
class BaseBank(ABC):
    ...
    # TODO لیست و مدلی از بانک‌ها باید داشته باشیم
    _bank: Bank = None
    ...
    def prepare_pay(self):
        ...
        self.prepare_amount()
        # TODO یک سری تنظیمات اولیه باید داشت
    ...
    def ready(self) -> Bank:
        self.pay()
        # TODO مدل بانک اینجا داره انگار هر بار ریکورد میگیره یعنی؟؟؟؟
        ...
        # TODO وضعیت پرداخت‌ها باید درست بشه
    ...
    def _set_bank_record(self):
        # TODO اینچا هم از مدل بانک دوباره استفاده شده است.
