...
#     related_articles_count.short_description = ' articles related to this category'

#     def related_articles_cumulative_count(self, instance):
#         return instance.articles_cumulative_count

#     related_articles_cumulative_count.short_description = 'articles counts related to this category'

# admin.site.register(KnowledgeCenterCategory, CategoryAdmin2)
