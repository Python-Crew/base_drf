...
urlpatterns = [
    ...
    path("knowledge_center/categories/<int:pk>/", category_detail, name="category_detail"),
    path("knowledge_center/selected_categories",main_page_category,name="main_page_categories",),
